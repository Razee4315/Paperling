...
const themeColors: Record<Theme, Record<string, string>> = {
    ...
    graphite: {
        ...
        codeBg: '#262220',
        codeText: '#a8a29e',
        blockquoteBg: 'rgba(38, 34, 32, 0.8)',
        accent: '#e7e5e4',
        syntaxH1: '#ffffff',
        syntaxH2: '#e7e5e4',
        syntaxH3: '#d6d3d1',
    ...
    nord: {
        ...
        codeBg: '#3b4252',
        codeText: '#d8dee9',
        blockquoteBg: 'rgba(59, 66, 82, 0.8)',
        accent: '#88c0d0',
        syntaxH1: '#eceff4',
        syntaxH2: '#e5e9f0',
        syntaxH3: '#d8dee9',
    ...
    midnight: {
        ...
        codeBg: '#1e293b',
        codeText: '#94a3b8',
        blockquoteBg: 'rgba(30, 41, 59, 0.8)',
        accent: '#38bdf8',
        syntaxH1: '#f1f5f9',
        syntaxH2: '#e2e8f0',
        syntaxH3: '#cbd5e1',
