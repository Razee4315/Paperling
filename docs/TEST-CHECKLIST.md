...
- [ ] Open the homepage on desktop and a phone. Check the Manrope headings, green/paper palette, paper illustration, and footer.
- [ ] Use “Take a look inside”; switch all four screenshot tabs. Arrow keys, Home, and End should work when a tab has focus.
...
- [ ] Follow an unknown URL. The custom 404 should offer a working route home.
